...
export const HERO_GLAMOUR = require('../../assets/catalog/family-hanukkiah-keepsake.webp');

export const HOME_HOLIDAY_THUMBS = {
  hanukkah: require('../../assets/home/holiday-hanukkah.png'),
  passover: require('../../assets/home/holiday-passover.png'),
  highHolidays: require('../../assets/home/holiday-high-holidays.png'),
  purim: require('../../assets/home/holiday-purim.png'),
} as const;
