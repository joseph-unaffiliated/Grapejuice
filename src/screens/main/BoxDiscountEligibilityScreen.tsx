    ...
    <WebContentPanel wide>
      ...
      >
        ...
        <Text style={[styles.body, { color: colors.textSecondary }]}>
          ...
          {formatCatalogDollars(LIST_BOX_VALUE_CENTS)} value). If you’re in the community this
          offering is designed for, attest below and we’ll email a discount code.
        </Text>
        ...
        {code ? (
          <View style={[styles.success, { borderColor: colors.border }]}>
            ...
            <Text style={[styles.body, { color: colors.textSecondary }]}>
              We emailed this to {email.trim() || 'you'}. Apply it at checkout when you subscribe to
              the box.
            </Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  content: { padding: spacing.lg, paddingBottom: 120, maxWidth: 560, alignSelf: 'center', width: '100%' },
