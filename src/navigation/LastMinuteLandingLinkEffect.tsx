...
import { readLastMinuteLandingFromWindow } from './lastMinuteLandingLink';

function navigateToLastMinuteLanding(): void {
  if (!navigationRef.isReady()) return;
  navigationRef.navigate('Main', { screen: 'LastMinuteLanding' });
}

/** Web: `/last-minute` → LastMinuteLanding. */
export function LastMinuteLandingLinkEffect() {
  ...
  const pending = useRef(readLastMinuteLandingFromWindow());
