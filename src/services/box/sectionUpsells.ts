...
const KIND_PATTERNS: Record<string, RegExp[]> = {
  ...
  napkins: [/napkin/i],
  'latke-stuffie': [/latke.*(stuffie|plush)|plush.*latke/i],
  'sufganiya-stuffie': [/sufgan.*(stuffie|plush)|plush.*sufgan|donut.*plush/i],
  'add-more-applesauce': [/applesauce|apple.?sauce/i],
  'more-gelt-small': [/gelt.*small|small.*gelt/i],
  'more-gelt-medium': [/gelt.*medium|medium.*gelt|^gelt$/i],
  'gelt-small×2': [/gelt.*small|small.*gelt/i],
